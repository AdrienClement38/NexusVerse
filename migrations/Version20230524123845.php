 ...
 */
final class Version20230524123845 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE score (id INT AUTO_INCREMENT NOT NULL, encounter_id INT DEFAULT NULL, team_id INT DEFAULT NULL, value INT NOT NULL, INDEX IDX_32993751D6E2FADC (encounter_id), INDEX IDX_32993751296CD8AE (team_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
